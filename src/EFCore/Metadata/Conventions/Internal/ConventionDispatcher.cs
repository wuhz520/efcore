...
namespace Microsoft.EntityFrameworkCore.Metadata.Conventions.Internal
{
    ...
    public partial class ConventionDispatcher
    {
        ...
        public virtual IConventionSkipNavigation? OnSkipNavigationInverseChanged(
            [NotNull] IConventionSkipNavigationBuilder navigationBuilder,
            // TODO-NULLABLE: Verify whether these should be nullable or not
        ...
        ///     doing so can result in application failures when updating to a new Entity Framework Core release.
        /// </summary>
        public virtual T Run<T>([NotNull] Func<T> func, [CanBeNull, CA.DisallowNull] ref IConventionForeignKey? foreignKey)
        {
